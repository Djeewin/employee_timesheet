...
with open('FullEmployeeList.csv', mode="r", encoding="utf-8", newline='') as f:
    reader = csv.reader(f)
    next(reader)
    dpt = dict(reader)  
...
#user info frame ///////////////////////////////////////////////////////////
logo_frame = tk.LabelFrame(frame, text="User Information")
logo_frame.grid(row=0, column=0, padx=10, pady=20)
